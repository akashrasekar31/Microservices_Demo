package com.akash.currencyconversionservice.controller;
...
import com.akash.currencyconversionservice.CurrencyExchangeProxy;
...
public class CurrncyConversionController {
	...
	public CurrencyConversion calculateCurrencyConversion(@PathVariable String from,@PathVariable String to,@PathVariable BigDecimal quantity) {
		...
		return new CurrencyConversion(currencyConversion.getId(), from, to, quantity, currencyConversion.getConversionMultiple(),
				quantity.multiply(currencyConversion.getConversionMultiple()), currencyConversion.getEnvironment()+" "+"restTamplate");
	}
